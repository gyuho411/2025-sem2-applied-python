...
class GameManager:
    ...
    def spawn_player_unit(self, unit_type):
        ...
        new_unit = None
        # [수정] 유닛 생성 시 콜백 함수(self.create_death_effect) 전달
        if unit_type == 1:
